...
import { LineChart, Line, BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, AreaChart, Area, PieChart, Pie, Cell, RadarChart, Radar, PolarGrid, PolarAngleAxis, PolarRadiusAxis, ComposedChart, Legend } from 'recharts';
import { Droplets, Thermometer, Wind, AlertCircle, TrendingUp, Cloud, Zap, Sun, CloudRain, Sprout, Trees, Circle, Filter, Leaf, Recycle, Gauge, Clock, Calendar, Users, Settings, BarChart3, Activity, Shield, Battery, Wifi, Cpu, Database, Camera, MapPin, Navigation, Satellite } from 'lucide-react';
        ...
        <div className="space-y-12">
          ...
          <section className="grid xl:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8 space-y-6 hover:border-green-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-green-500/10">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-sm font-bold px-4 py-2 rounded-full ${
                    metric.change.startsWith('+') ? 'bg-green-900/50 text-green-300 border border-green-700/50' : 'bg-red-900/50 text-red-300 border border-red-700/50'
                  }`}>
                    {metric.change}
                  </span>
                </div>
                <div className="space-y-2">
                  <p className="text-gray-400 text-lg font-medium">{metric.label}</p>
          ...
          <section>
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-white">Environmental Monitoring</h2>
            ...
            <div className="grid md:grid-cols-6 gap-6">
              {[
                ...
                <div key={i} className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-xl p-6 space-y-4 hover:border-green-500/30 transition-all duration-300 group">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500 mt-1 capitalize">{sensor.trend}</p>
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-baseline gap-2">
                      ...
                      <p className="text-gray-500 text-xs">{sensor.unit}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <section className="grid xl:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-white">Multi-Sensor Comprehensive Analysis</h2>
            ...
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-white mb-8">Soil Nutrition Comprehensive Analysis</h2>
              <ResponsiveContainer width="100%" height={400}>
          ...
          <section className="grid xl:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-white mb-8">Crop Health Detailed Metrics</h2>
              <ResponsiveContainer width="100%" height={400}>
            ...
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-white mb-8">Field Distribution & Performance</h2>
              <ResponsiveContainer width="100%" height={400}>
                <PieChart>
                  <Pie
                    data={fieldData}
          ...
          <section>
            <h2 className="text-3xl font-bold text-white mb-8">Resource Management & Optimization</h2>
            <div className="grid xl:grid-cols-2 gap-8">
              {/* Resource Utilization */}
              <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
                <h3 className="text-xl font-bold text-white mb-6">Resource Utilization Analytics</h3>
              ...
              <div className="space-y-6">
                <h3 className="text-xl font-bold text-white">Equipment Monitoring Dashboard</h3>
                {equipmentData.map((equipment, index) => (
                  <div key={index} className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-xl p-6 hover:border-green-500/30 transition-all duration-300">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                          equipment.status === 'Active' ? 'bg-green-900/50 text-green-400 border border-green-700/50' : 'bg-yellow-900/50 text-yellow-400 border border-yellow-700/50'
                        }`}>
                        ...
                        <div>
                          ...
                          <p className={`text-sm ${
                            equipment.status === 'Active' ? 'text-green-400' : 'text-yellow-400'
                          }`}>
                            {equipment.status}
                          </p>
                        </div>
                      ...
                      <div className="text-right">
                        <p className="text-2xl font-bold text-white">{equipment.efficiency}%</p>
          ...
          <section>
            <h2 className="text-3xl font-bold text-white mb-8">Weather Intelligence & Forecasting</h2>
            <div className="grid lg:grid-cols-4 gap-8">
              {/* Current Weather Conditions */}
              <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-6 lg:col-span-1">
                <div className="flex items-center gap-4 mb-6">
                  <Sun className="w-10 h-10 text-yellow-400" />
                  <div>
                    <p className="text-gray-400 text-sm">Current</p>
                    <p className="text-xl font-bold text-white">Sunny, 26°C</p>
                  </div>
                </div>
              ...
              <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-6 lg:col-span-3">
                <h3 className="text-lg font-bold text-white mb-6">7-Day Extended Forecast</h3>
                <div className="grid grid-cols-7 gap-2">
                  {weatherForecast.map((day, index) => (
                    <div key={index} className="text-center bg-gray-800/30 rounded-lg p-3 hover:bg-gray-800/50 transition-colors duration-300">
                      <p className="font-semibold text-white mb-2">{day.day}</p>
                      ...
                      <div className="space-y-1">
                        <p className="font-semibold text-white">{day.high}°</p>
                        <p className="text-gray-400 text-sm">{day.low}°</p>
                        <p className="text-blue-400 text-sm">{day.precipitation}%</p>
                        <p className="text-gray-500 text-xs">{day.wind} km/h</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <section className="grid xl:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-white mb-6">Pest Monitoring Center</h2>
              <div className="space-y-4">
                {pestData.map((pest, index) => (
                  <div key={index} className="bg-gray-800/30 rounded-xl p-4 hover:bg-gray-800/50 transition-colors duration-300">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-semibold text-white text-lg">{pest.pest}</p>
                        <p className="text-gray-400 text-sm">Detected: {pest.count} | Trend: {pest.trend}</p>
                        <p className="text-gray-500 text-xs mt-1">Treatment: {pest.treatment}</p>
                      </div>
                      <span className={`px-4 py-2 rounded-full text-sm font-semibold ${
                        pest.risk === 'Low' ? 'bg-green-900/50 text-green-300 border border-green-700/50' : 
                        pest.risk === 'Very Low' ? 'bg-blue-900/50 text-blue-300 border border-blue-700/50' :
            ...
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-white mb-6">Yield Optimization Analytics</h2>
              <ResponsiveContainer width="100%" height={300}>
          ...
          <section className="grid xl:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-white mb-8">Performance Analytics Dashboard</h2>
              <div className="grid grid-cols-2 gap-6 mb-8">
                {[
                  ...
                  <div key={i} className="bg-gray-800/30 rounded-xl p-6 text-center space-y-3 hover:bg-gray-800/50 transition-colors duration-300">
          ...
          <section>
            <h2 className="text-3xl font-bold text-white mb-8">Financial Analytics & ROI Tracking</h2>
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <ResponsiveContainer width="100%" height={400}>
          ...
          <section>
            <h2 className="text-3xl font-bold text-white mb-8">Smart Irrigation Management</h2>
            <div className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {irrigationSchedule.map((schedule, index) => (
                  <div key={index} className="bg-gray-800/30 rounded-xl p-6 hover:bg-gray-800/50 transition-colors duration-300">
                    <div className="flex items-center justify-between mb-4">
                      <span className="font-bold text-white text-lg">{schedule.zone}</span>
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                        schedule.status === 'Completed' ? 'bg-green-900/50 text-green-300 border border-green-700/50' :
                        schedule.status === 'In Progress' ? 'bg-blue-900/50 text-blue-300 border border-blue-700/50' :
          ...
          <section>
            <h2 className="text-3xl font-bold text-white mb-8">Sustainability & Environmental Impact</h2>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-2xl p-8 text-center space-y-6 hover:border-green-500/30 transition-all duration-300">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className={`inline-flex px-4 py-2 rounded-full text-sm font-semibold ${
                      metric.impact === 'High' ? 'bg-green-900/50 text-green-300 border border-green-700/50' :
          ...
          <section>
            <h2 className="text-3xl font-bold text-white mb-8">Advanced Technology Stack</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-xl p-6 text-center space-y-4 hover:border-purple-500/30 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{tech.status}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section>
            <h2 className="text-3xl font-bold text-white mb-8">System Health & Security</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-gray-900/80 backdrop-blur-lg border border-gray-800 rounded-xl p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-gray-400 text-sm">{system.metric}</p>
                      <p className="text-xl font-bold text-white">{system.value}</p>
